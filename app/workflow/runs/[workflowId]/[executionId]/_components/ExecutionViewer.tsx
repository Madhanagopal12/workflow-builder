...
export default function ExecutionViewer({
  ...
  return (
    <div className="flex w-full h-full">
      <aside className="flex flex-col grow overflow-hidden w-[440px] max-w-[440px] min-w-[440px] border-r-2 border-separate">
        ...
        <Separator />
        <div className="overflow-auto px-2 py-4 h-full">
